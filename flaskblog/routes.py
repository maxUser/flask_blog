...
def home():
    ...
    posts = Post.query.order_by(Post.date_posted.desc()).paginate(page=page, per_page=5) # sqlalchemy
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        # don't need db.sessions.add() because the data is already in the db
